...
function Kid() {
    ...
    const navigateClothing = () => {
        navigate("/clothing/kid/clothing");
    }
    const navigateShoes = () => {
        navigate("/clothing/kid/shoes");
    }
    const back = () => {
        navigate("/");
    }
    ...
    return (
        <div className="Kid">
            <header className="kid-header-container">
                <div className="kid-header">
                    <img onClick={back} src={arrow} alt="flecha"/>
                    <h2>Niño</h2>
                </div>
                <div>
                    <h4 onClick={navigateKid} style={{color: "#202020"}}>Niño</h4>
    ...
    return(
        <div className="Kid">
            <header className="kid-header-container">
                ...
                <div>
                    <h4 onClick={navigateKid}>Niño</h4>
...
export { Kid, KidRopa, KidZapatilla };